...
AI CLI(Claude Code, Codex, Gemini, Cursor 등) 사용자들이 터미널에서 근처 사용자를 발견하고 채팅할 수 있는 CLI P2P 채팅 도구. 경량 신호 서버로 사용자 발견 + relay fallback, Hyperswarm으로 P2P 직접 연결. npm 배포(`npx cling-talk`).
...
## Current Milestone: v1.0.1 Bug Fix & UX Polish

**Goal:** 채팅 UI 버그 수정 및 입력 UX 개선
...
- ✓ 긴 입력 텍스트 미노출 버그 수정 — v1.0.1 Phase 6
- ✓ 채팅 스크롤 상단 고정 버그 수정 — v1.0.1 Phase 6
- ✓ 입력 커서 좌/우 화살표 이동 — v1.0.1 Phase 7
- ✓ 슬래시 명령어 자동완성 — v1.0.1 Phase 7
- ✓ 상태바 위치 변경 (입력 필드 윗 라인) — v1.0.1 Phase 8
- ✓ 시스템 메시지 시각적 구분 — v1.0.1 Phase 8
- ✓ 내/상대 메시지 색상 구분 — v1.0.1 Phase 8
- ✓ /quit → /exit 명령어 변경 — v1.0.1 Phase 8
...
- npm 패키지 배포, `npx cling-talk` 즉시 실행
...
- `/settings`, `/chat` 명령어 placeholder
- 클라이언트 zod 검증 미사용 (type assertion)
- Nyquist VALIDATION.md 미완료 (5 phases)

---
*Last updated: 2026-03-20 after v1.0.1 milestone complete (all 3 phases done)*
