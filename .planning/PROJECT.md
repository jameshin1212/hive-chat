...
- [ ] 최초 실행 시 닉네임 설정 + 고유ID 자동 발급 (닉네임#태그 형식, 예: coder#3A7F)
- [ ] 사용하는 AI CLI 선택 (Claude Code, Codex, Gemini, Cursor 등)
- [ ] IP geolocation 기반 위치 파악
- [ ] 근처 사용자 목록 (1/3/5/10km 범위 선택)
...
---
*Last updated: 2026-03-19 after Phase 1 discussion (renamed from Double Talk to Cling Talk)*
