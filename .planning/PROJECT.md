...
## Current Milestone: v1.1 Settings & Cleanup

**Goal:** /settings 명령어 구현 및 placeholder 명령어 정리

**Target features:**
- /settings 명령어: 닉네임 변경, AI CLI 변경, 프로필 확인
- /chat placeholder 제거
- Known tech debt 정리
...
- [ ] /settings 명령어: 닉네임 변경
- [ ] /settings 명령어: AI CLI 변경
- [ ] /settings 명령어: 프로필 확인
- [ ] /chat placeholder 명령어 제거
