...
- ✓ 고유ID(닉네임#태그)로 위치 무관 친구추가/삭제 — Phase 4: Friends
- ✓ 친구 목록 로컬 파일 저장 (세션 간 유지) — Phase 4: Friends
- ✓ P2P 직접 연결 (Hyperswarm) + relay fallback — Phase 5: P2P Upgrade
- ✓ 연결 상태 표시 (direct/relay/disconnected 색상 구분) — Phase 5: P2P Upgrade
...
---
*Last updated: 2026-03-19 after Phase 5 complete — P2P upgrade with Hyperswarm, ConnectionManager transport abstraction, StatusBar color indicators. v1.0 milestone complete.*
