...
- **Global scope**: `/Users/jamie/Jamie_Dev/claude_chat/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/jamie/Jamie_Dev/claude_chat/.claude/notes/`)
...
2. Glob `/Users/jamie/Jamie_Dev/claude_chat/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/jamie/Jamie_Dev/claude_chat/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/jamie/Jamie_Dev/claude_chat/.claude/notes/` — works in any directory
